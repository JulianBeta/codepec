...
export const Establecimientos = () => {
  return (
    <div className='contenedorpagina'>
      <div className='titulo1'><p>SERVICIOS A ESTABLECIMIENTOS DE COMERCIO</p></div>

      <div className='titulo2'> <h2>ASESORÍA, ACOMPAÑAMIENTO Y REPRESENTACIÓN ANTE INSPECTORES DE POLICÍA POR MEDIDAS CORRECTIVAS</h2>
      </div>
      <div className='titulo3'> 
        <h3> Acciones específicas:
        </h3></div>
      ...
      <div className='titulo2'> <h2>VERIFICACIÓN JURÍDICA DE CUMPLIMIENTO DE REQUISITOS PARA EL DESARROLLO DE ACTIVIDAD ECONÓMICA</h2>
      </div>
      ...
      <div> <ul>
       ...
       <div> <h3>Ventajas para el cliente:</h3></div>
        <div><h4>
          <ul>
      ...
      <div> <h2>ASESORÍA EN CONTRATACIÓN LABORAL</h2></div>
        <div><h4>
      ...
      <div> <h2>ESTRUCTURACIÓN DE CONTRATOS CON PROVEEDORES Y TERCEROS</h2></div>
        <div><h3>
          Acciones específicas:
        </h3></div>
          <div><ul>
          ...
          <div><h3>Ventajas para el cliente:</h3>
          <div>
          <ul>
      ...
      <div> <h2>REPRESENTACIÓN EN PROCESOS POR COMPETENCIA DESLEAL Y PROPIEDAD INTELECTUAL</h2>
      </div>
       <div><h3>
          Acciones específicas:
        </h3></div>
        <div>
         ...
         <div> <h3>Ventajas para el cliente:</h3></div>
          <div><ul><li>Protección ante sanciones arbitrarias o desproporcionadas.</li>
