...
export const Establecimientos = () => {
        return (
                ...
                <div className='contenedorpagina'>
                        <div ><h4 className='titulo1'>SERVICIOS A ESTABLECIMIENTOS DE COMERCIO</h4></div>
                        <div className='contenedormenus' >
                                <br></br>
                                <Dropdown title="ASESORÍA, ACOMPAÑAMIENTO Y REPRESENTACIÓN ANTE INSPECTORES DE POLICÍA POR MEDIDAS CORRECTIVAS">
                                ...
                                <Dropdown title="VERIFICACIÓN JURÍDICA DE CUMPLIMIENTO DE REQUISITOS PARA EL DESARROLLO DE ACTIVIDAD ECONÓMICA">
                                        <h3 className='submenu-title'>Acciones específicas:</h3>
                                        ...
                                        <li className='li'>Cumplimiento legal garantizado para evitar conflictos con las autoridades.</li>
                                        <br></br>
                                </Dropdown>

                                <Dropdown title="ASESORÍA EN CONTRATACIÓN LABORAL">
                                        <h3 className='submenu-title'>Acciones específicas:</h3>
                                        ...
                                        <li className='li'>Asesoría en medidas disciplinarias y terminación de contratos.</li>
                                        <br></br>
                                        <h3 className="submenu-title">Ventajas para el cliente:</h3>
                                        <li className='li'>Reducción de riesgos legales y demandas laborales.</li>
                                        <li className='li'>Optimización de la gestión de recursos humanos.</li>
                                        <br></br>
                                </Dropdown>

                                <Dropdown title="REPRESENTACIÓN EN PROCESOS POR COMPETENCIA DESLEAL Y PROPIEDAD INTELECTUAL">
                                        <h3 className='submenu-title'>Acciones específicas:</h3>
                                        ...
                                        <li className='li'>Representación en acciones judiciales y extrajudiciales.</li>
                                        <br></br>
                                        <h3 className="submenu-title">Ventajas para el cliente:</h3>
                                        <li className='li'>Protección ante sanciones arbitrarias o desproporcionadas.</li>
                                        <li className='li'>Protección de la marca y activos intangibles.</li>
                                        <li className='li'>Prevención de disputas comerciales.</li>
                                        <li className='li'>Recuperación de daños por infracciones.</li>
                                        <br></br>
                                </Dropdown>
                        </div>
                        <GoToTop />
